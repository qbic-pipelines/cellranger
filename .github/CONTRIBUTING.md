...
For further information/help, please consult the [qbic-pipelines/cellranger documentation](./docs/usage.md).

## Pipeline contribution conventions

To make the qbic-pipelines/cellranger code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.
